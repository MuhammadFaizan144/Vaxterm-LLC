            ...
            <section>
                <div className="max-w-[1141px] w-full bg-white mx-auto rounded-2xl  lg:mt-24 mt:20">
                    <div className="flex flex-col lg:flex-row h-auto lg:h-[506px]">
                        ...
                        <div className="w-full lg:w-1/2 h-[506px] lg:p-0 p-6 lg:h-full rounded-lg">
                            <img
                        ...
                        <div className="w-full lg:w-1/2 p-6 lg:p-10 flex flex-col justify-center">
                            ...
                            <p className="text-[#191D28] text-[18px] mb-4 flex items-center gap-2">
                                <img src="/images/Home/Section2/iconTitle.png" alt="" />
                                ABOUT US
                            </p>

                            <div className="flex flex-wrap justify-around gap-2 bg-gray-100 rounded-full px-1 py-1.5 max-w-[503px] h-auto mb-6 border border-gray-400  sm:text-[22px] text-[16px]">
                                <button className="px-5 py-2 rounded-full hover:bg-[#388EF6] hover:text-white text-[#191D28]">
                                    Our Mission
                                </button>
                                <button className="px-5 py-2 rounded-full hover:bg-[#388EF6] hover:text-white text-[#191D28]">
                                    Our Vision
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3 text-[20px] text-gray-800">
                                    <span className="w-5 h-5 flex items-center justify-center bg-blue-500 text-white rounded-full text-sm">✓</span>
